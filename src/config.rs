...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("remote.sopmex.net".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("SOPMEX Remote".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remote.sopmex.net"];
pub const RS_PUB_KEY: &str = "VC+DmhWi1xBV38k1Wjx3z4FMYiR9fOZi9X0faPVeJLI=";
